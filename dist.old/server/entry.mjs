...
import { $ as ClientAddressNotAvailable, $t as removeTrailingForwardSlash, A as renderEndpoint, At as REDIRECT_STATUS_CODES, B as isRoute404, Bt as appendForwardSlash, C as decodeKey, Ct as SessionStorageSaveError, Dt as i18nNoLocaleFoundInPath, F as sequence, Ft as nodeRequestAbortControllerCleanupSymbol, Gt as hasFileExtension, H as MultiLevelEncodingError, Ht as collapseDuplicateSlashes, I as copyRequest, It as originPathnameSymbol, J as AstroError, K as BodySizeLimitError, Kt as isInternalPath, L as findRouteToRewrite, Lt as pipelineSymbol, Mt as appSymbol, N as getRouteGenerator, Nt as clientAddressSymbol, Ot as ASTRO_ERROR_HEADER, P as RedirectSinglePageBuiltModule, Pt as fetchStateSymbol, Q as CacheNotEnabled, R as getOriginPathname, Rt as responseSentSymbol$1, St as SessionStorageInitError, U as validateAndDecodePathname, Ut as collapseDuplicateTrailingSlashes, V as isRoute500, Vt as collapseDuplicateLeadingSlashes, W as NOOP_MIDDLEWARE_FN, Wt as fileExtension, X as ActionsReturnedInvalidDataError, Xt as prependForwardSlash$1, Y as ActionNotFoundError, Yt as joinPaths, Z as AstroResponseHeadersReassigned, Zt as removeLeadingForwardSlash, a as createConsoleLogger, c as getParams, d as getFallbackRoute, dt as LocalsNotAnObject, en as slash, f as routeHasHtmlExtension, ft as LocalsReassigned, g as getPattern, h as SERVER_ISLAND_COMPONENT, i as PipelineFeatures, jt as REROUTABLE_STATUS_CODES, kt as ASTRO_GENERATOR, l as getProps, m as routeIsRedirect, mt as MiddlewareNotAResponse, n as ALL_PIPELINE_FEATURES, o as AstroIntegrationLogger, ot as ForbiddenRewrite, p as routeIsFallback, pt as MiddlewareNoDataOrNextCalled, q as readBodyWithLimit, r as Pipeline, s as routeComparator, t as Slots, u as getCustom404Route, w as generateCspDigest, wt as StaticClientAddressNotAvailable, xt as ResponseSentError, y as renderPage, yt as PrerenderClientAddressNotAvailable, z as setOriginPathname, zt as shouldAppendForwardSlash } from "./chunks/render_CHac7bFQ.mjs";
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/usr/bin/npm" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/analysis.astro",
			"pathname": "/analysis",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/accounts.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/analysis.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/auth/setup.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/backup/restore.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/budgets.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/api/goals/[id].ts",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/goals.ts",
			"pathname": "/api/goals",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/api/transactions/[id].ts",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/transactions.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/budgets.astro",
			"pathname": "/budgets",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/charts.astro",
			"pathname": "/charts",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/goals.astro",
			"pathname": "/goals",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/help.astro",
			"pathname": "/help",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/setup.astro",
			"pathname": "/setup",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/transactions.astro",
...
var _page0 = () => import("./chunks/node_hJvhCneX.mjs");
var _page1 = () => import("./chunks/analysis_C3KH-MkM.mjs");
var _page2 = () => import("./chunks/accounts_BpuIlMdP.mjs");
var _page3 = () => import("./chunks/analysis_DhVb5yRp.mjs");
var _page4 = () => import("./chunks/login_D_IcyxET.mjs");
var _page5 = () => import("./chunks/logout_SYGWhUAy.mjs");
var _page6 = () => import("./chunks/setup_CCISEQfD.mjs");
var _page7 = () => import("./chunks/export_B2epKZ7Y.mjs");
var _page8 = () => import("./chunks/restore_BueygA_u.mjs");
var _page9 = () => import("./chunks/budgets_3E7BWACo.mjs");
var _page10 = () => import("./chunks/_id__CtjjEG4h.mjs");
var _page11 = () => import("./chunks/goals_1qPnkQb7.mjs");
var _page12 = () => import("./chunks/_id__D9kmv3jk.mjs");
var _page13 = () => import("./chunks/transactions_CWGU50Ri.mjs");
var _page14 = () => import("./chunks/budgets_6gi2vUTQ.mjs");
var _page15 = () => import("./chunks/charts_CNbS6f7n.mjs");
var _page16 = () => import("./chunks/goals_BImIRvha.mjs");
var _page17 = () => import("./chunks/help_BN1OxqxJ.mjs");
var _page18 = () => import("./chunks/login_MxxxLDo0.mjs");
var _page19 = () => import("./chunks/settings_D2rXpWDO.mjs");
var _page20 = () => import("./chunks/setup_D2AmTHB2.mjs");
var _page21 = () => import("./chunks/transactions_DPGDhYXv.mjs");
var _page22 = () => import("./chunks/index_BGfk0kbf.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/node.js", _page0],
	["src/pages/analysis.astro", _page1],
	["src/pages/api/accounts.ts", _page2],
	...
	["src/pages/api/backup/export.ts", _page7],
	["src/pages/api/backup/restore.ts", _page8],
	["src/pages/api/budgets.ts", _page9],
	["src/pages/api/goals/[id].ts", _page10],
	["src/pages/api/goals.ts", _page11],
	["src/pages/api/transactions/[id].ts", _page12],
	["src/pages/api/transactions.ts", _page13],
	["src/pages/budgets.astro", _page14],
	["src/pages/charts.astro", _page15],
	["src/pages/goals.astro", _page16],
	["src/pages/help.astro", _page17],
	["src/pages/login.astro", _page18],
	["src/pages/settings.astro", _page19],
	["src/pages/setup.astro", _page20],
	["src/pages/transactions.astro", _page21],
	["src/pages/index.astro", _page22]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/castolo/desarrollos/FinTrack/","cacheDir":"file:///home/castolo/desarrollos/FinTrack/node_modules/.astro/","outDir":"file:///home/castolo/desarrollos/FinTrack/dist/","srcDir":"file:///home/castolo/desarrollos/FinTrack/src/","publicDir":"file:///home/castolo/desarrollos/FinTrack/public/","buildClientDir":"file:///home/castolo/desarrollos/FinTrack/dist/client/","buildServerDir":"file:///home/castolo/desarrollos/FinTrack/dist/server/","adapterName":"@astrojs/node","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/node.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/analysis","isIndex":false,"type":"page","pattern":"^\\/analysis\\/?$","segments":[[{"content":"analysis","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/analysis.astro","pathname":"/analysis","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/accounts","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/accounts\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"accounts","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/accounts.ts","pathname":"/api/accounts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/analysis","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/analysis\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"analysis","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/analysis.ts","pathname":"/api/analysis","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/login","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/login\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/login.ts","pathname":"/api/auth/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/logout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/logout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/logout.ts","pathname":"/api/auth/logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/setup","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/setup\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"setup","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/setup.ts","pathname":"/api/auth/setup","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/backup/export","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/backup\\/export\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"backup","dynamic":false,"spread":false}],[{"content":"export","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/backup/export.ts","pathname":"/api/backup/export","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/backup/restore","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/backup\\/restore\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"backup","dynamic":false,"spread":false}],[{"content":"restore","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/backup/restore.ts","pathname":"/api/backup/restore","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/budgets","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/budgets\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"budgets","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/budgets.ts","pathname":"/api/budgets","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/goals/[id]","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/goals\\/([^/]+?)\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"goals","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/api/goals/[id].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/goals","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/goals\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"goals","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/goals.ts","pathname":"/api/goals","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/transactions/[id]","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/transactions\\/([^/]+?)\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"transactions","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/api/transactions/[id].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/transactions","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/transactions\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"transactions","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/transactions.ts","pathname":"/api/transactions","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/budgets","isIndex":false,"type":"page","pattern":"^\\/budgets\\/?$","segments":[[{"content":"budgets","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/budgets.astro","pathname":"/budgets","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/charts","isIndex":false,"type":"page","pattern":"^\\/charts\\/?$","segments":[[{"content":"charts","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/charts.astro","pathname":"/charts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/goals","isIndex":false,"type":"page","pattern":"^\\/goals\\/?$","segments":[[{"content":"goals","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/goals.astro","pathname":"/goals","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/help","isIndex":false,"type":"page","pattern":"^\\/help\\/?$","segments":[[{"content":"help","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/help.astro","pathname":"/help","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/login","isIndex":false,"type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/settings","isIndex":false,"type":"page","pattern":"^\\/settings\\/?$","segments":[[{"content":"settings","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/settings.astro","pathname":"/settings","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/setup","isIndex":false,"type":"page","pattern":"^\\/setup\\/?$","segments":[[{"content":"setup","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/setup.astro","pathname":"/setup","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/transactions","isIndex":false,"type":"page","pattern":"^\\/transactions\\/?$","segments":[[{"content":"transactions","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/transactions.astro","pathname":"/transactions","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/i18n.LAbz0WpS.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/castolo/desarrollos/FinTrack/src/pages/analysis.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/budgets.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/charts.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/goals.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/help.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/login.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/settings.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/setup.astro",{"propagation":"none","containsHead":true}],["/home/castolo/desarrollos/FinTrack/src/pages/transactions.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.CXz4Nm7t.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_DS5V7T-N.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","/home/castolo/desarrollos/FinTrack/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/node/server.js":"entry.mjs","\u0000virtual:astro:page:src/pages/api/goals/[id]@_@ts":"chunks/_id__CtjjEG4h.mjs","\u0000virtual:astro:page:src/pages/api/transactions/[id]@_@ts":"chunks/_id__D9kmv3jk.mjs","\u0000virtual:astro:page:src/pages/api/accounts@_@ts":"chunks/accounts_BpuIlMdP.mjs","\u0000virtual:astro:page:src/pages/analysis@_@astro":"chunks/analysis_C3KH-MkM.mjs","\u0000virtual:astro:page:src/pages/api/analysis@_@ts":"chunks/analysis_DhVb5yRp.mjs","\u0000virtual:astro:page:src/pages/api/budgets@_@ts":"chunks/budgets_3E7BWACo.mjs","\u0000virtual:astro:page:src/pages/budgets@_@astro":"chunks/budgets_6gi2vUTQ.mjs","\u0000virtual:astro:page:src/pages/charts@_@astro":"chunks/charts_CNbS6f7n.mjs","\u0000virtual:astro:page:src/pages/api/backup/export@_@ts":"chunks/export_B2epKZ7Y.mjs","\u0000virtual:astro:page:src/pages/api/goals@_@ts":"chunks/goals_1qPnkQb7.mjs","\u0000virtual:astro:page:src/pages/goals@_@astro":"chunks/goals_BImIRvha.mjs","\u0000virtual:astro:page:src/pages/help@_@astro":"chunks/help_BN1OxqxJ.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_BGfk0kbf.mjs","\u0000virtual:astro:page:src/pages/api/auth/login@_@ts":"chunks/login_D_IcyxET.mjs","\u0000virtual:astro:page:src/pages/login@_@astro":"chunks/login_MxxxLDo0.mjs","\u0000virtual:astro:page:src/pages/api/auth/logout@_@ts":"chunks/logout_SYGWhUAy.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/node@_@js":"chunks/node_hJvhCneX.mjs","\u0000virtual:astro:page:src/pages/api/backup/restore@_@ts":"chunks/restore_BueygA_u.mjs","\u0000virtual:astro:page:src/pages/settings@_@astro":"chunks/settings_D2rXpWDO.mjs","\u0000virtual:astro:page:src/pages/api/auth/setup@_@ts":"chunks/setup_CCISEQfD.mjs","\u0000virtual:astro:page:src/pages/setup@_@astro":"chunks/setup_D2AmTHB2.mjs","/home/castolo/desarrollos/FinTrack/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_DW8Eujuy.mjs","\u0000virtual:astro:page:src/pages/api/transactions@_@ts":"chunks/transactions_CWGU50Ri.mjs","\u0000virtual:astro:page:src/pages/transactions@_@astro":"chunks/transactions_DPGDhYXv.mjs","/home/castolo/desarrollos/FinTrack/src/components/Sidebar.astro?astro&type=script&index=0&lang.ts":"_astro/Sidebar.astro_astro_type_script_index_0_lang.BnLYSsHc.js","/home/castolo/desarrollos/FinTrack/src/pages/budgets.astro?astro&type=script&index=0&lang.ts":"_astro/budgets.astro_astro_type_script_index_0_lang.BAlKEoGP.js","@astrojs/react/client.js":"_astro/client.CpZbMCvk.js","/home/castolo/desarrollos/FinTrack/src/pages/goals.astro?astro&type=script&index=0&lang.ts":"_astro/goals.astro_astro_type_script_index_0_lang.tiqzOz5u.js","/home/castolo/desarrollos/FinTrack/src/pages/login.astro?astro&type=script&index=0&lang.ts":"_astro/login.astro_astro_type_script_index_0_lang.DEYeh3pU.js","/home/castolo/desarrollos/FinTrack/src/pages/settings.astro?astro&type=script&index=0&lang.ts":"_astro/settings.astro_astro_type_script_index_0_lang.xnEfaMiB.js","/home/castolo/desarrollos/FinTrack/src/pages/setup.astro?astro&type=script&index=0&lang.ts":"_astro/setup.astro_astro_type_script_index_0_lang.xnMBl-r3.js","/home/castolo/desarrollos/FinTrack/src/pages/transactions.astro?astro&type=script&index=0&lang.ts":"_astro/transactions.astro_astro_type_script_index_0_lang.BwOzNFza.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/home/castolo/desarrollos/FinTrack/src/components/Sidebar.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`client-ip-sidebar`);e&&(e.textContent=window.location.hostname);var t=document.getElementById(`btn-lang-es`),n=document.getElementById(`btn-lang-en`);t&&t.addEventListener(`click`,()=>{document.cookie=`lang=es; path=/; max-age=31536000`,window.location.reload()}),n&&n.addEventListener(`click`,()=>{document.cookie=`lang=en; path=/; max-age=31536000`,window.location.reload()});"],["/home/castolo/desarrollos/FinTrack/src/pages/budgets.astro?astro&type=script&index=0&lang.ts","document.getElementById(`budget-form`)?.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`budget-category`).value,n=parseFloat(document.getElementById(`budget-amount`).value);try{let e=await fetch(`/api/budgets`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({category_id:t,amount:n})});if(!e.ok){let t=await e.json();throw Error(t.error||`Error al guardar el presupuesto.`)}window.location.reload()}catch(e){alert(`> ERROR: ${e.message}`)}});"],["/home/castolo/desarrollos/FinTrack/src/pages/login.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`login-form`),t=document.getElementById(`error-output`),n=document.cookie.includes(`lang=en`);e.addEventListener(`submit`,async e=>{e.preventDefault(),t.classList.add(`hidden`);let r=document.getElementById(`username`),i=document.getElementById(`password`);try{let e=await fetch(`/api/auth/login`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({username:r.value,password:i.value})}),t=await e.json();if(!e.ok)throw Error(t.error||(n?`Incorrect username or password.`:`Nombre de usuario o contraseña incorrectos.`));window.location.href=`/`}catch(e){t.textContent=`> ERROR: ${e.message}`,t.classList.remove(`hidden`)}});var r=document.getElementById(`btn-lang-es`),i=document.getElementById(`btn-lang-en`);r&&r.addEventListener(`click`,()=>{document.cookie=`lang=es; path=/; max-age=31536000`,window.location.reload()}),i&&i.addEventListener(`click`,()=>{document.cookie=`lang=en; path=/; max-age=31536000`,window.location.reload()});"],["/home/castolo/desarrollos/FinTrack/src/pages/settings.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`backup-file`),t=document.getElementById(`file-label`),n=document.getElementById(`restore-form`),r=document.getElementById(`status-output`),i=document.cookie.includes(`lang=en`);e?.addEventListener(`change`,()=>{e.files&&e.files.length>0?(t.textContent=i?`File: ${e.files[0].name}`:`Archivo: ${e.files[0].name}`,t.classList.remove(`text-secondary`),t.classList.add(`text-main`,`font-bold`)):t.textContent=i?`Select .json file`:`Seleccionar archivo .json`}),n?.addEventListener(`submit`,async t=>{if(t.preventDefault(),!e.files||e.files.length===0)return;let n=e.files[0],a=new FileReader;if(r.classList.remove(`hidden`,`border-red-900`,`text-red-500`,`bg-red-950/20`,`border-green-900`,`text-green-500`,`bg-green-950/20`),r.textContent=i?`> Reading backup file...`:`> Leyendo archivo de respaldo...`,r.classList.add(`border-border-main`,`text-secondary`,`bg-surface-main`),!confirm(i?`Are you sure you want to restore this backup? All current data will be replaced and your session will end.`:`¿Estás seguro de que deseas restaurar este respaldo? Todos tus datos actuales serán reemplazados y la sesión se cerrará.`)){r.classList.add(`hidden`);return}a.onload=async e=>{try{let t=e.target?.result,n=JSON.parse(t);r.textContent=i?`> Transferring data to server...`:`> Transfiriendo datos al servidor...`;let a=await fetch(`/api/backup/restore`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(n)}),o=await a.json();if(!a.ok)throw Error(o.error||(i?`Error restoring backup.`:`Error al restaurar el respaldo.`));r.classList.remove(`border-border-main`,`text-secondary`,`bg-surface-main`),r.classList.add(`border-green-900`,`text-green-500`,`bg-green-950/20`),r.textContent=i?`✅ Database successfully restored. Redirecting to login...`:`✅ Base de datos restaurada correctamente. Redirigiendo a inicio de sesión...`,setTimeout(()=>{window.location.href=`/login`},2e3)}catch(e){r.classList.remove(`border-border-main`,`text-secondary`,`bg-surface-main`),r.classList.add(`border-red-900`,`text-red-500`,`bg-red-950/20`),r.textContent=`> ERROR: ${e.message}`}},a.readAsText(n)});"],["/home/castolo/desarrollos/FinTrack/src/pages/setup.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`setup-form`),t=document.getElementById(`error-output`),n=document.cookie.includes(`lang=en`);e.addEventListener(`submit`,async e=>{e.preventDefault(),t.classList.add(`hidden`);let r=document.getElementById(`username`),i=document.getElementById(`password`),a=document.getElementById(`setup-lang`),o=document.getElementById(`setup-currency`);try{let e=await fetch(`/api/auth/setup`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({username:r.value,password:i.value})}),t=await e.json();if(!e.ok)throw Error(t.error||(n?`An unexpected error occurred while setting up the user.`:`Ocurrió un error inesperado al configurar el usuario.`));document.cookie=`lang=${a.value}; path=/; max-age=31536000`,document.cookie=`currency=${o.value}; path=/; max-age=31536000`,window.location.href=`/`}catch(e){t.textContent=`> ERROR: ${e.message}`,t.classList.remove(`hidden`)}});var r=document.getElementById(`btn-lang-es`),i=document.getElementById(`btn-lang-en`);r&&r.addEventListener(`click`,()=>{document.cookie=`lang=es; path=/; max-age=31536000`,window.location.reload()}),i&&i.addEventListener(`click`,()=>{document.cookie=`lang=en; path=/; max-age=31536000`,window.location.reload()});"],["/home/castolo/desarrollos/FinTrack/src/pages/transactions.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`filter-search`),t=document.getElementById(`filter-type`),n=document.getElementById(`filter-account`),r=document.getElementById(`filter-month`),i=document.getElementById(`clear-filters`),a=document.querySelectorAll(`.transaction-row`),o=document.getElementById(`visible-count`);function s(){let i=e.value.toLowerCase().trim(),s=t.value,c=n.value,l=r.value,u=0;a.forEach(e=>{let t=e.getAttribute(`data-type`),n=e.getAttribute(`data-account`),r=e.getAttribute(`data-desc`)?.toLowerCase()||``,a=e.getAttribute(`data-date`)||``,o=r.includes(i),d=s===`all`||t===s,f=c===`all`||n===c,p=!l||a.startsWith(l);o&&d&&f&&p?(e.classList.remove(`hidden`),u++):e.classList.add(`hidden`)}),o&&(o.textContent=String(u))}e?.addEventListener(`input`,s),t?.addEventListener(`change`,s),n?.addEventListener(`change`,s),r?.addEventListener(`change`,s),i?.addEventListener(`click`,()=>{e&&(e.value=``),t&&(t.value=`all`),n&&(n.value=`all`),r&&(r.value=``),s()}),document.querySelectorAll(`.delete-btn`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=e.target.getAttribute(`data-id`);if(!t)return;let n=document.cookie.includes(`lang=en`)?`Are you sure you want to delete this transaction? The amount will be reverted from the account balance.`:`¿Estás seguro de que deseas eliminar esta transacción? Se revertirá su importe del saldo de la cuenta.`;if(confirm(n))try{let e=await fetch(`/api/transactions/${t}`,{method:`DELETE`});if(!e.ok){let t=await e.json();throw Error(t.error||`Error al eliminar la transacción`)}window.location.reload()}catch(e){alert(`> ERROR: ${e.message}`)}})});"]],"assets":["/favicon.ico","/favicon.svg","/_astro/client.CpZbMCvk.js","/_astro/goals.astro_astro_type_script_index_0_lang.tiqzOz5u.js","/_astro/i18n.LAbz0WpS.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"j9+RQqh7cAG05kGITrSUlgaRLw6PiVUHgKOX6OCjJTY=","sessionConfig":{"driver":"unstorage/drivers/fs-lite","options":{"base":"/home/castolo/desarrollos/FinTrack/node_modules/.astro/sessions"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var mode = "standalone";
var client = "file:///home/castolo/desarrollos/FinTrack/dist/client/";
var server = "file:///home/castolo/desarrollos/FinTrack/dist/server/";
var port = 4321;
